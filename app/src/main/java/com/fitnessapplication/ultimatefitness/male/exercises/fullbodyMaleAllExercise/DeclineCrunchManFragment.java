...
public class DeclineCrunchManFragment extends Fragment {
    ...
    public DeclineCrunchManFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_decline_crunch_man, container, false);
