package com.fitnessapplication.ultimatefitness.male.exercises.legMaleAllExercise;
...
public class SingleLegGlueBridgeFragment extends Fragment {
    ...
    public SingleLegGlueBridgeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_single_leg_glue_bridge, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.legFrameContainer, new SingleLegHipRaiseFragment());
                ft.commit();
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.legFrameContainer, new LungeswithDumbbellFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
