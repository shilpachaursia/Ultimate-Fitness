...
public class flyDumbbellInclineFragment extends Fragment {
    ...
    public flyDumbbellInclineFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_fly_dumbbell_incline, container, false);
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.chestMaleFrameCont, new DumbbellFloorPressFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
