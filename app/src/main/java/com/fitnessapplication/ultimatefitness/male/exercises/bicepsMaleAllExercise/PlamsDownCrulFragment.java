...
public class PlamsDownCrulFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_plams_down_crul, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.bicepsMaleFrameContainer, new StandingBarbellCrulFragment());
                ft.commit();
