...
public class InvertShoulderPressFragment extends Fragment {
    ...
    public InvertShoulderPressFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_invert_shoulder_press, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.shoulderFrameContainer, new LateralRaiseFragment());
                ft.commit();
