...
public class InclineDumbbellCurlFragment extends Fragment {
    ...
    public InclineDumbbellCurlFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_incline_dumbbell_curl, container, false);
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.bicepsMaleFrameContainer, new EzBarCrulFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
