...
public class KneelingLatPullDOwnFragment extends Fragment {
    ...
    public KneelingLatPullDOwnFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_kneeling_lat_pull_d_own, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.backMaleFrameContainer, new LatPullDOwnFragment());
                ft.commit();
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.backMaleFrameContainer, new KettlebellSwingFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
