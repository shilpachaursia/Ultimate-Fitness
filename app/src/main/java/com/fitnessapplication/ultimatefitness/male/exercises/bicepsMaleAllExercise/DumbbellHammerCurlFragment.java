...
public class DumbbellHammerCurlFragment extends Fragment {
    ImageView nextMale,startMale,resumeMale,pauseMale;
    GifImageView gifMale;
    TextView readyMale,endMale;
    TextToSpeech textToSpeechMale;
    CircularView circularViewWithTimerMale;
    private AdView mAdView;
    public DumbbellHammerCurlFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_dumbbell_hammer_curl, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.bicepsMaleFrameContainer, new BandHammerCrulFragment());
                ft.commit();
