...
public class DumbbellSingleArmROwFragment extends Fragment {
    ...
    public DumbbellSingleArmROwFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_dumbbell_single_arm_r_ow, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.backMaleFrameContainer, new InvertRowFragment());
                ft.commit();
