...
public class BandHammerCrulFragment extends Fragment {
   ...
   @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_band_hammer_crul, container, false);
       ...
       nextMale.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               ...
               ft.replace(R.id.bicepsMaleFrameContainer, new ChinUpFragment());
               ft.commit();
       ...
       backMale.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               FragmentManager rs = getFragmentManager();
               FragmentTransaction ft = rs.beginTransaction();
               ft.replace(R.id.bicepsMaleFrameContainer, new DumbbellHammerCurlFragment());
               ft.commit();
               circularViewWithTimerMale.stopTimer();
           }
       });
