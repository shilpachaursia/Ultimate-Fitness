...
public class deltDriverFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_delt_driver, container, false);
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.FBMaleFrameChanger, new DeclineCrunchManFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
