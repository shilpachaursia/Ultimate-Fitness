...
public class hangingLegAriseFragment extends Fragment {
    ...
    public hangingLegAriseFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_hanging_leg_arise, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.FBMaleFrameChanger, new JumpingManFragment());
                ft.commit();
