package com.fitnessapplication.ultimatefitness.male.exercises.backMaleAllExercise;
...
public class BentOverDumbbellAlternativeFragment extends Fragment {
    ...
    public BentOverDumbbellAlternativeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_bent_over_dumbbell_alternative, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.backMaleFrameContainer, new ChestSupportDumbbellFragment());
                ft.commit();
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.backMaleFrameContainer, new BandBentOverRowFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
