package com.fitnessapplication.ultimatefitness.male.exercises.fullbodyMaleAllExercise;
...
public class dumbbellSideBendFragment extends Fragment {
    ...
    public dumbbellSideBendFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_dumbbell_side_bend2, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.FBMaleFrameChanger, new halfPushUpFragment());
                ft.commit();
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.FBMaleFrameChanger, new deltDriverFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
