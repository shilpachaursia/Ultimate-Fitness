...
public class KettlebellSwingFragment extends Fragment {
    ...
    public KettlebellSwingFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_kettlebell_swing, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.backMaleFrameContainer, new KneelingLatPullDOwnFragment());
                ft.commit();
