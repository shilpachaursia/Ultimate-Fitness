...
public class DumbbellScaptionFragment extends Fragment {
    ...
    public DumbbellScaptionFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_dumbbell_scaption, container, false);
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.shoulderFrameContainer, new DumbbellPushUpPressFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
