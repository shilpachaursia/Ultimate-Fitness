package com.fitnessapplication.ultimatefitness.male.exercises.absMenAllExercise;
...
public class SlowHangingLegRaiseFragment extends Fragment {
    ...
    public SlowHangingLegRaiseFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_slow_hanging_leg_raise, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.absFrameContainer, new SumoSquatFragment());
                ft.commit();
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.absFrameContainer, new SidePlankFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
