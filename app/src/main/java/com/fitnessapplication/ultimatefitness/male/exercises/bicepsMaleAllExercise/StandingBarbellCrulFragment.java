...
public class StandingBarbellCrulFragment extends Fragment {
    ...
    public StandingBarbellCrulFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_standing_barbell_crul, container, false);
