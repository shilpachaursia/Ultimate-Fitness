...
public class EzBarCrulFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_ez_bar_crul, container, false);
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.bicepsMaleFrameContainer, new ConcentratedCurlFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
