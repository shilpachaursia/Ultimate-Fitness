...
public class ResistanceBandfacePullFragment extends Fragment {
    ...
    public ResistanceBandfacePullFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_resistance_bandface_pull, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.shoulderFrameContainer, new ButtleProofShoulderFragment());
                ft.commit();
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.shoulderFrameContainer, new MilitrayPressFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
