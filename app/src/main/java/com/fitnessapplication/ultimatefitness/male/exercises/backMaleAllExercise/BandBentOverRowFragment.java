...
public class BandBentOverRowFragment extends Fragment {
    ...
    public BandBentOverRowFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_band_bent_over_row, container, false);
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.backMaleFrameContainer, new BackBarbelSquatFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
