...
public class SingleLegHipRaiseFragment extends Fragment {
    ...
    public SingleLegHipRaiseFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_single_leg_hip_raise, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.legFrameContainer, new SquatJumpBoyFragment());
                ft.commit();
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.legFrameContainer, new SingleLegGlueBridgeFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
