...
public class ButtleProofShoulderFragment extends Fragment {
    ...
    public ButtleProofShoulderFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_buttle_proof_shoulder, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.shoulderFrameContainer, new TrxLYTFragment());
                ft.commit();
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.shoulderFrameContainer, new ResistanceBandfacePullFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
