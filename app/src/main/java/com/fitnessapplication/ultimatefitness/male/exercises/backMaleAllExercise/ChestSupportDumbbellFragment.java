...
public class ChestSupportDumbbellFragment extends Fragment {
    ...
    public ChestSupportDumbbellFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_chest_support_dumbbell, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.backMaleFrameContainer, new DeadLiftFragment());
                ft.commit();
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.backMaleFrameContainer, new BentOverDumbbellAlternativeFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
