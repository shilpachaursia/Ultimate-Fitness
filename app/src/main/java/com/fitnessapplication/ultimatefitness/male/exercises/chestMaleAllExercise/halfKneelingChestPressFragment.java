package com.fitnessapplication.ultimatefitness.male.exercises.chestMaleAllExercise;
...
public class halfKneelingChestPressFragment extends Fragment {
    ...
    public halfKneelingChestPressFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_half_kneeling_chest_press, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.chestMaleFrameCont, new halfKneelingChestPressFragment());
                ft.commit();
                ...
                new CircularView.OptionsBuilder()
                        ...
                        .setCircularViewCallback(new CircularViewCallback() {
                            ...
                            public void onTimerFinish() {
                                ...
                                FragmentManager rs = getFragmentManager();
                                FragmentTransaction ft = rs.beginTransaction();
                                ft.replace(R.id.chestMaleFrameCont, new InclineDumbbellBenchPressFragment());
                                ft.commit();
                            }
