...
public class BixSquatJumpFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_bix_squat_jump, container, false);
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.legFrameContainer, new AlternativeDropLungeFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
