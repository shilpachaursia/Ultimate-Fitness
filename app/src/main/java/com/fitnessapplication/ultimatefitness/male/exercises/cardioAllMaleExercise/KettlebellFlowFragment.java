package com.fitnessapplication.ultimatefitness.male.exercises.cardioAllMaleExercise;
...
public class KettlebellFlowFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_kettlebell_flow, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.cardioFrameContainer, new MedicineBallFragment());
                ft.commit();
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.cardioFrameContainer, new JumpingLungeFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
