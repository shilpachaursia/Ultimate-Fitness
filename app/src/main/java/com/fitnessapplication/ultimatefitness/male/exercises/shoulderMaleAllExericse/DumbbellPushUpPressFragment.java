...
public class DumbbellPushUpPressFragment extends Fragment {
    ...
    public DumbbellPushUpPressFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_dumbbell_push_up_press, container, false);
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.shoulderFrameContainer, new CableFlyFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
