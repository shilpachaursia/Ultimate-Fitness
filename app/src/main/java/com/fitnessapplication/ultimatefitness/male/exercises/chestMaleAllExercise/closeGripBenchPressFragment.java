...
public class closeGripBenchPressFragment extends Fragment {
    ...
    public closeGripBenchPressFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_close_grip_bench_press, container, false);
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.chestMaleFrameCont, new benchPressFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
