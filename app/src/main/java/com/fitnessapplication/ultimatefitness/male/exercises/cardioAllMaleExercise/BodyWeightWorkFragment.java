...
public class BodyWeightWorkFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_body_weight_work, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.cardioFrameContainer, new BurpeesFragment());
                ft.commit();
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.cardioFrameContainer, new BattelRoFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
