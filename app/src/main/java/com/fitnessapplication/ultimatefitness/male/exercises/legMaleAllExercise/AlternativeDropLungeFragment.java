...
public class AlternativeDropLungeFragment extends Fragment {
    ...
    public AlternativeDropLungeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_alternative_drop_lunge, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.legFrameContainer, new BixSquatJumpFragment());
                ft.commit();
