...
public class ConcentratedCurlFragment extends Fragment {
    ...
    public ConcentratedCurlFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_concentrated_curl, container, false);
