package com.fitnessapplication.ultimatefitness.male.exercises.bicepsMaleAllExercise;
...
public class KneelingDumbbellCrulFragment extends Fragment {
    ...
    public KneelingDumbbellCrulFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_kneeling_dumbbell_crul, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.bicepsMaleFrameContainer, new PlamsDownCrulFragment());
                ft.commit();
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.bicepsMaleFrameContainer, new HammerCrulFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
