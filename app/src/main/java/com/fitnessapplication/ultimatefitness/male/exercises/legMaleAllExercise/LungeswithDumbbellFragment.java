...
public class LungeswithDumbbellFragment extends Fragment {
    ...
    public LungeswithDumbbellFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_lungeswith_dumbbell, container, false);
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.legFrameContainer, new FrontSquatFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
