...
public class HammerCrulFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_hammer_crul, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.bicepsMaleFrameContainer, new KneelingDumbbellCrulFragment());
                ft.commit();
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.bicepsMaleFrameContainer, new InclineDumbbellCurlFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
