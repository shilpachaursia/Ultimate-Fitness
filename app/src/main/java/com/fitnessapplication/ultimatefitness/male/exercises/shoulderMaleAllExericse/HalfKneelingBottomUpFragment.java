...
public class HalfKneelingBottomUpFragment extends Fragment {
    ...
    public HalfKneelingBottomUpFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_half_kneeling_bottom_up, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.shoulderFrameContainer, new InclineDumbbellBenchPressFragment());
                ft.commit();
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.shoulderFrameContainer, new DumbbellScaptionFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
