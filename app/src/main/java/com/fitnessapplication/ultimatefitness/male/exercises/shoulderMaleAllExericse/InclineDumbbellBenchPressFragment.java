package com.fitnessapplication.ultimatefitness.male.exercises.shoulderMaleAllExericse;
...
public class InclineDumbbellBenchPressFragment extends Fragment {
    ...
    public InclineDumbbellBenchPressFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_incline_dumbbell_bench_press2, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.shoulderFrameContainer, new InvertShoulderPressFragment());
                ft.commit();
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.shoulderFrameContainer, new HalfKneelingBottomUpFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
