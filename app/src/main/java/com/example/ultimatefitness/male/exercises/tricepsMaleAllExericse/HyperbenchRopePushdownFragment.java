...
public class HyperbenchRopePushdownFragment extends Fragment {
    ...
    public HyperbenchRopePushdownFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_hyperbench_rope_pushdown, container, false);
