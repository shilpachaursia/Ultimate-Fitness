...
public class DumbbellTricepsFragment extends Fragment {
    ...
    public DumbbellTricepsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_dumbbell_triceps, container, false);
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.tricepsMaleFrameContainer, new DumbbellTricepsFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
