...
public class WeightedBenchDipFragment extends Fragment {
    ...
    public WeightedBenchDipFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_weighted_bench_dip, container, false);
