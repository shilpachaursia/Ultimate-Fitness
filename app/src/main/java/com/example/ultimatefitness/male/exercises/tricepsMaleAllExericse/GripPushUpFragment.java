...
public class GripPushUpFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_grip_push_up, container, false);
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.tricepsMaleFrameContainer, new GripBenchPressFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
