package com.example.ultimatefitness.male.exercises.tricepsMaleAllExericse;
...
public class ReverseSingleCableFragment extends Fragment {
    ...
    public ReverseSingleCableFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_reverse_single_cable, container, false);
        ...
        nextMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.tricepsMaleFrameContainer, new StandOverheadRopeFragment());
                ft.commit();
        ...
        backMale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.tricepsMaleFrameContainer, new HyperbenchRopePushdownFragment());
                ft.commit();
                circularViewWithTimerMale.stopTimer();
            }
        });
