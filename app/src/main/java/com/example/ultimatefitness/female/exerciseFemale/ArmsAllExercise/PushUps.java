...
public class PushUps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_puch_ips);
        imageViewforword = findViewById(R.id.PUForewordBtn);
        imageViewback=findViewById(R.id.PUBackBtn);
        gif=findViewById(R.id.PUGif);
        ready=findViewById(R.id.PUStartPoint);
        end=findViewById(R.id.PUEndPoint);
        imageViewback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PushUps.this,ArmsCrossJumpingJacks.class));
            }
        });
                ...
                new CircularView.OptionsBuilder()
                        ...
                        .setCircularViewCallback(new CircularViewCallback() {
                            ...
                            public void onTimerCancelled() {
                                Toast.makeText(PushUps.this, "Timer Cancelled", Toast.LENGTH_SHORT).show();
                            }
                        });
