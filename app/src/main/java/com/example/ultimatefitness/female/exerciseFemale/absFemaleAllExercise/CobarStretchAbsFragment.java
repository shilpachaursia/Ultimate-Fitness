...
public class CobarStretchAbsFragment extends Fragment {
    ImageView nextBBA,backBBA,startBBA,resumeBBA,pauseBBA;
    GifImageView gifBBA;
    TextView readyBBA,endBBA;
    TextToSpeech textToSpeechBBA;
    CircularView circularViewWithTimerBBA;
    private AdView mAdView;
    public CobarStretchAbsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_cobar_stretch_abs, container, false);
        nextBBA=view.findViewById(R.id.CJJAForwordBtn);
        ...
        nextBBA.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentManager rs = getFragmentManager();
                FragmentTransaction ft = rs.beginTransaction();
                ft.replace(R.id.absFrameLayout, new LyingTwistStretchAbsFragment());
                ft.commit();
        ...
        backBBA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.replace(R.id.absFrameLayout,new PlankAbsFragment()).commit();
                circularViewWithTimerBBA.stopTimer();
            }
        });
