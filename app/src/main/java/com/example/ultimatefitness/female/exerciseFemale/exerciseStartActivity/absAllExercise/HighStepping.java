...
public class HighStepping extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif=findViewById(R.id.highSteppingGif);
        ready=findViewById(R.id.readytogo);
        end= findViewById(R.id.highsteppingendpoint);
        ...
        imageViewback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(HighStepping.this,CrossJumpingJack.class));
            }
        });
        imageViewforword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(HighStepping.this,StandingBycycleCrunches.class));
            }
        });
                ...
                new CircularView.OptionsBuilder()
                        ...
                        .setCircularViewCallback(new CircularViewCallback() {
                            ...
                            public void onTimerCancelled() {
                                ...
                                Toast.makeText(HighStepping.this, "CircularCallback: Timer Cancelled ", Toast.LENGTH_SHORT).show();
                            }
                        });
