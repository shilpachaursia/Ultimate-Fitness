...
public class LegsArise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_legs_arise);
        gif=findViewById(R.id.legsAriseGif);
        ready=findViewById(R.id.readytogo);
        end=findViewById(R.id.LGEndPoint);
        ...
        imageViewback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(LegsArise.this,FlutterKicks.class));
            }
        });
        imageViewforword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LegsArise.this,ButtBridge.class));
            }
        });
                ...
                new CircularView.OptionsBuilder()
                        ...
                        .setCircularViewCallback(new CircularViewCallback() {
                            ...
                            public void onTimerCancelled() {
                                ...
                                Toast.makeText(LegsArise.this, "CircularCallback: Timer Cancelled ", Toast.LENGTH_SHORT).show();
                            }
                        });
