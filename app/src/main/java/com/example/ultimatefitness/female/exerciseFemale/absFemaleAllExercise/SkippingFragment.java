...
public class SkippingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_skipping, container, false);
        ...
        nextBBA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.absFrameLayout, new PlankAbsFragment());
                ft.commit();
        ...
        backBBA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.replace(R.id.absFrameLayout,new ButtBridgeAbsFragment()).commit();
                circularViewWithTimerBBA.stopTimer();
            }
        });
