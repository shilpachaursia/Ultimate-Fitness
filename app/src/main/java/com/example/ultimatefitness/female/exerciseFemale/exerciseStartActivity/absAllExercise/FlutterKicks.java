...
public class FlutterKicks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif=findViewById(R.id.flutterKickGif);
        ready=findViewById(R.id.readytogo);
        end=findViewById(R.id.FKEndingtext);
        ...
        imageViewback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(FlutterKicks.this,MountainClimber.class));
            }
        });
        imageViewforword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(FlutterKicks.this,LegsArise.class));
            }
        });
                ...
                new CircularView.OptionsBuilder()
                        ...
                        .setCircularViewCallback(new CircularViewCallback() {
                            ...
                            public void onTimerCancelled() {
                                ...
                                Toast.makeText(FlutterKicks.this, "CircularCallback: Timer Cancelled ", Toast.LENGTH_SHORT).show();
                            }
                        });
