...
public class PlankAbsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_plank_abs, container, false);
        ...
        nextBBA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.absFrameLayout, new CobarStretchAbsFragment());
                ft.commit();
        ...
        backBBA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.replace(R.id.absFrameLayout,new SkippingFragment()).commit();
                circularViewWithTimerBBA.stopTimer();
            }
        });
