...
public class StandingBycycleCrunches extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_standing_bycycle_crunches);
        gif=findViewById(R.id.standingBicycleCrunchGif);
        ready=findViewById(R.id.readytogo);
        end=findViewById(R.id.SBCendingpoint);
        ...
        imageViewback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(StandingBycycleCrunches.this,HighStepping.class));
            }
        });
        imageViewforword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(StandingBycycleCrunches.this,RussianTwist.class));
            }
        });
                ...
                new CircularView.OptionsBuilder()
                        ...
                        .setCircularViewCallback(new CircularViewCallback() {
                            ...
                            public void onTimerCancelled() {
                                ...
                                Toast.makeText(StandingBycycleCrunches.this, "CircularCallback: Timer Cancelled ", Toast.LENGTH_SHORT).show();
                            }
                        });
