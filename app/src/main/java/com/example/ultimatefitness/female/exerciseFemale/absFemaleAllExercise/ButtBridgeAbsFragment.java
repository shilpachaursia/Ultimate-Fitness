...
public class ButtBridgeAbsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_butt_bridge_abs, container, false);
...
//        mAdView =view.findViewById(R.id.adView);
        ...
        nextBBA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.absFrameLayout, new SkippingFragment());
                ft.commit();
        ...
        backBBA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.replace(R.id.absFrameLayout,new LegAriseAbsFragment()).commit();
                circularViewWithTimerBBA.stopTimer();
            }
        });
