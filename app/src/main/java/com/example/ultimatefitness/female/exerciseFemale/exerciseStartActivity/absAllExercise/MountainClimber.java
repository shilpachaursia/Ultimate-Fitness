...
public class MountainClimber extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gif=findViewById(R.id.mountainClimberGif);
        ready=findViewById(R.id.readytogo);
        end=findViewById(R.id.MCEndingpoint);
        ...
        imageViewback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MountainClimber.this,RussianTwist.class));
            }
        });
        imageViewforword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MountainClimber.this,FlutterKicks.class));
            }
        });
                ...
                new CircularView.OptionsBuilder()
                        ...
                        .setCircularViewCallback(new CircularViewCallback() {
                            ...
                            public void onTimerCancelled() {
                                ...
                                Toast.makeText(MountainClimber.this, "CircularCallback: Timer Cancelled ", Toast.LENGTH_SHORT).show();
                            }
                        });
